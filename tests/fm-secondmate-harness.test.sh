...
test_spawn_secondmate_harness_model_token() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '{\"attribution\":{\"commit\":\"\"}}' --model 'opus'" \
...
test_spawn_secondmate_harness_model_and_effort_tokens() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '{\"attribution\":{\"commit\":\"\"}}' --model 'opus' --effort 'high'" \
