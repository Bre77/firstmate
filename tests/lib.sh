...
# Fixture directories must be deterministically non-group/other-writable
# regardless of the invoking shell's ambient umask, or a permissive host
# default (e.g. 002) makes fm-procevent's private-directory check reject an
# otherwise-correct fixture state dir.
umask 022
