...
config/max-crew  concurrent ship/scout admission ceiling for this home; LOCAL, gitignored, and not inherited (each home, primary or secondmate, sets its own); override for one spawn with FM_MAX_CREW; see docs/configuration.md "Concurrent crew admission cap"
