...
| `fm-pr-lib.sh`           | Own canonical task and PR validation, private atomic PR-poll publication and identity-bound retirement, and the best-effort fleet-provenance PR label (docs/configuration.md "PR label") |
