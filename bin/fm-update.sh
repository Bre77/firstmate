...
#
#   (b) Fast-forward sweep (all models). Fast-forwards the running firstmate repo's
#       default branch from origin, then fast-forwards every registered secondmate
#       home. Local homes are treehouse worktrees of this same repo or standalone
#       clones; remote routes update their configured code root on that host and
#       then fast-forward the persistent home to that root.
#
