...
family_for_basename() {
  case "$1" in
    ...
    fm-backend-herdr-composer-live-smoke.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 37246
tests/fm-afk-pi-herdr-return-e2e.test.sh 55
tests/fm-afk-return.test.sh 1414
tests/fm-ask-user-authority.test.sh 72
tests/fm-backend-cmux-smoke.test.sh 19
tests/fm-backend-cmux.test.sh 2618
tests/fm-backend-herdr-focus-flash-e2e.test.sh 14945
tests/fm-backend-orca.test.sh 15166
tests/fm-backend-tmux-smoke.test.sh 193
tests/fm-backend-zellij-smoke.test.sh 13
tests/fm-backend-zellij.test.sh 5754
tests/fm-backend.test.sh 18342
tests/fm-backlog-atomicity.test.sh 101433
tests/fm-backlog-handoff.test.sh 37815
tests/fm-bearings-board-render.test.sh 1075
tests/fm-bearings-board.test.sh 3159
tests/fm-bearings-snapshot.test.sh 59523
tests/fm-betterstack.test.sh 6822
tests/fm-bootstrap-network-parallel.test.sh 7139
tests/fm-bootstrap.test.sh 20180
tests/fm-branch-supervision.test.sh 4208
tests/fm-busy-adapter-wiring.test.sh 2700
tests/fm-busy-state.test.sh 2668
tests/fm-calm-pi-extension.test.sh 163
tests/fm-captain-msg.test.sh 7212
tests/fm-check-unregister.test.sh 335
tests/fm-classify-corr-token.test.sh 12599
tests/fm-classify-decision-key.test.sh 1208
tests/fm-claude-stop-autoarm-live-e2e.test.sh 22
tests/fm-claude-stop-autoarm.test.sh 60610
tests/fm-clickstack.test.sh 8675
tests/fm-cmux-claude-composer-live-e2e.test.sh 12
tests/fm-codex-continuity-live-e2e.test.sh 12
tests/fm-composer-matrix-live-e2e.test.sh 15
tests/fm-control-relaunch.test.sh 50134
tests/fm-control.test.sh 35203
tests/fm-crew-memory-cap.test.sh 9886
tests/fm-cursor-harness.test.sh 30096
tests/fm-cursor-primary-live-e2e.test.sh 13
tests/fm-cursor-primary.test.sh 52955
tests/fm-daemon.test.sh 22229
tests/fm-documentation-audiences.test.sh 536
tests/fm-extension-binding.test.sh 4628
tests/fm-fleet-snapshot-view.test.sh 6131
tests/fm-fleet-sync.test.sh 30861
tests/fm-fork-deliver.test.sh 545
tests/fm-gate-refuse.test.sh 4388
tests/fm-gitignore-config.test.sh 34
tests/fm-gotmp.test.sh 1002
tests/fm-grok-continuity-live-e2e.test.sh 12
tests/fm-grok-stop-live-e2e.test.sh 14
tests/fm-guard-stale-banner.test.sh 4705
tests/fm-harbor.test.sh 5268
tests/fm-harness-adapter-instructions-live-e2e.test.sh 13
tests/fm-harness-adapter-references.test.sh 95
tests/fm-harness-liveness-drift-live-e2e.test.sh 16
tests/fm-herdr-session-cleanup.test.sh 5500
tests/fm-herdr-submit-confirm-live-e2e.test.sh 13
tests/fm-herdr-version-floor-live-e2e.test.sh 12
tests/fm-home-summary-refresh.test.sh 33523
tests/fm-inactive-reconcile.test.sh 39958
tests/fm-kimi-harness.test.sh 16347
tests/fm-lint-workflows.test.sh 98
tests/fm-muse-harness.test.sh 32875
tests/fm-muse-signals-live-e2e.test.sh 14
tests/fm-no-mistakes-required.test.sh 385
tests/fm-notify-captain.test.sh 299
tests/fm-on.test.sh 10247
tests/fm-opencode-primary-live-e2e.test.sh 20
tests/fm-operational-input.test.sh 227
tests/fm-peek-remote.test.sh 301
tests/fm-pending-reply.test.sh 21108
tests/fm-pi-branch-extension.test.sh 269
tests/fm-pi-branch-live-e2e.test.sh 11
tests/fm-pi-primary-live-e2e.test.sh 13
tests/fm-pi-watch-extension.test.sh 149
tests/fm-pr-check-security.test.sh 105913
tests/fm-pr-check.test.sh 5188
tests/fm-procevent-quota.test.sh 1336
tests/fm-procevent-when.test.sh 15314
tests/fm-procevent.test.sh 62504
tests/fm-project-origin.test.sh 115
tests/fm-public-followup.test.sh 59889
tests/fm-quota-array-dispatch-live-e2e.test.sh 11
tests/fm-quota-choose.test.sh 1025
tests/fm-remote-backlog-handoff.test.sh 30346
tests/fm-remote-doctor.test.sh 4438
tests/fm-remote-entrypoint.test.sh 118
tests/fm-remote-job-orphan-reap.test.sh 3201
tests/fm-remote-job.test.sh 60848
tests/fm-remote-reply.test.sh 40618
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 159527
tests/fm-remote-secondmate-parent-binding.test.sh 21589
tests/fm-remote-secondmate-trace-context.test.sh 48571
tests/fm-remote-transport-lanes.test.sh 61137
tests/fm-secondmate-harness.test.sh 141739
tests/fm-secondmate-lifecycle-e2e.test.sh 6475
tests/fm-secondmate-liveness.test.sh 13221
tests/fm-secondmate-reconcile.test.sh 23315
tests/fm-secondmate-safety.test.sh 38614
tests/fm-secondmate-sync.test.sh 12011
tests/fm-send-inbox-doorbell-live-e2e.test.sh 12
tests/fm-send-inbox.test.sh 33331
tests/fm-send-remote-delivery.test.sh 14348
tests/fm-send-resolve-key.test.sh 9244
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 92
tests/fm-send-secondmate-marker.test.sh 2982
tests/fm-session-lock-ancestry.test.sh 1472
tests/fm-session-start.test.sh 129036
tests/fm-sessionstart-hook-live-e2e.test.sh 10
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 10
tests/fm-sessionstart-nudge.test.sh 27638
tests/fm-shared-captain-inheritance.test.sh 3259
tests/fm-spawn-dispatch-profile.test.sh 61584
tests/fm-spawn-pool-base-freshen.test.sh 35594
tests/fm-spawn-worktree-settle.test.sh 5522
tests/fm-startup-memory-budget.test.sh 4557
tests/fm-startup-network.test.sh 55052
tests/fm-stow-cascade.test.sh 3472
tests/fm-subagent-pretool-check.test.sh 1367
tests/fm-supervision-events.test.sh 1121
tests/fm-tangle-guard.test.sh 130737
tests/fm-task-delivery.test.sh 2963
tests/fm-task-inbox.test.sh 23039
tests/fm-teardown-endpoint-safety.test.sh 3338
tests/fm-teardown.test.sh 62658
tests/fm-test-fixture-cleanup.test.sh 1115
tests/fm-test-fixtures.test.sh 224
tests/fm-test-isolation-proof.test.sh 1773
tests/fm-tmux-agent-liveness.test.sh 1426
tests/fm-tool-update-check.test.sh 12918
tests/fm-trace-context-lib.test.sh 242
tests/fm-trace-context-spawn.test.sh 43429
tests/fm-turnend-guard.test.sh 2992
tests/fm-update.test.sh 2729
tests/fm-vendor-auth-probe.test.sh 42904
tests/fm-voice-relay.test.sh 28026
tests/fm-wake-daemon-lifecycle-e2e.test.sh 5859
tests/fm-wake-drain-open-decisions-cursor.test.sh 15327
tests/fm-wake-drain-open-decisions.test.sh 4368
tests/fm-wake-drain-unread-status.test.sh 8485
tests/fm-wake-queue.test.sh 41397
tests/fm-watch-arm.test.sh 58558
tests/fm-watch-checkpoint.test.sh 4928
tests/fm-watch-recovery-loop.test.sh 2196
tests/fm-watch-triage.test.sh 215918
tests/fm-watcher-lock.test.sh 54621
EOF
}
